function []=plot_geometry_test_functions(x,h,n_np,L,n_el,csi,W,L_el,n_gauss,x_gauss)

% Plot of geometry with test functions
figure('Color',[1 1 1])
axes('FontSize',14)
...
hold off
title('Geometry with test functions','FontSize',14)
